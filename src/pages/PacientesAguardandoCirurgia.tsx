...
const DetalhesEsperaCirurgiaModal = ({ patient, onClose, user, onUpdatePatient, showToast }: {
    ...
    const [aguardandoCirurgia, setAguardandoCirurgia] = useState<string>(patient.aguardandoCirurgia || '');
    ...
    const handleSave = () => {
        ...
        const updatedPatient = {
            ...
            aguardandoCirurgia: aguardandoCirurgia || undefined,
        };
                     ...
                     <fieldset>
                        ...
                        <div className="espera-cirurgia-grid">
                            <div className="form-group form-group-highlight">
                                ...
                                <input
                                    type="text"
                                    name="aguardandoCirurgia"
                                    value={aguardandoCirurgia}
                                    onChange={(e) => setAguardandoCirurgia(e.target.value)}
                                    disabled={user.role !== 'admin'}
                                    placeholder="Descreva o status da espera"
                                />
                            </div>
                            <div className="form-group form-group-highlight">
                        ...
                        {filteredPatients.map(p => {
                            ...
                            return (
                                <tr key={p.id}>
                                    ...
                                    <td>{p.aguardandoCirurgia || 'N/A'}</td>
